...
const Labels = ({headline, setHeadline, tagline, setTagline, subtitle, setSubtitle, labels, setLabels, mapLocation}) => {
    ...
    <div className="mb-3 w-5/6 relative">
        <input value={tagline} onChange={handleTagline} disabled={!labels} id="tagline" type="text" placeholder="Headline" className={`${labels?'text-text':'text-gray-400'} bg-background  border py-1.5 px-4 pl-[4.3rem] w-full border-accent rounded-none placeholder-transparent focus:outline-none`}/>
    ...
    <div className="mb-3 w-5/6 relative">
        <input value={subtitle} onChange={handleSubtitle} disabled={!labels} id="subtitle" type="text" placeholder="Headline" className={`${labels?'text-text':'text-gray-400'} bg-background  border py-1.5 px-4 pl-[4.3rem] w-full border-accent rounded-none placeholder-transparent focus:outline-none`}/>
